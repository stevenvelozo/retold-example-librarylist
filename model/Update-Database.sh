...
echo "--> Adding any new tables to MySQL"
time mysql -uadmin -pverysecurepassword -h$IP librarylist < ./schema/mysql/LibraryList-CreateDatabase.mysql.sql

echo "--> Updating model to v01"
time mysql -uadmin -pverysecurepassword -h$IP librarylist < ./schema/mysql/LibraryList-UpdateDatabase-01.mysql.sql
